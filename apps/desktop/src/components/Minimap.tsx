...
/** 응답 본문 미니맵: 버킷 축소 렌더 + 뷰포트 인디케이터 + 검색 매치 마크 + 클릭/드래그 이동. */
export function Minimap({ lines, scrollRef, matchLines }: Props) {
  ...
  useEffect(() => {
    ...
    const buckets = buildMinimapBuckets(lines, bucketCount, matchLines);
